...
Each model evaluates and ranks all responses (including its own) without knowing which model produced which response. This anonymization prevents bias and ensures objective evaluation 
